...
class ImprovExamEnrollSuccessPageView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => ImprovExamEnrollSuccessPageViewState();
}

class ImprovExamEnrollSuccessPageViewState extends GeneralPageViewState{
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Stack(
                    children: [
                      textLine(0, -0.25, 'O teu formulário foi'),
