...
class NewCAECertificatePageView extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => NewCAECertificatePageViewState();
}

class NewCAECertificatePageViewState extends GeneralPageViewState{
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          title('Certidão de', context),
                          title('Aproveitamento Escolar', context),
                        ],
                      ),
                    ),
                  ],
