...
class NewCCGLCertificatePageView extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => NewCCGLCertificatePageViewState();
}

class NewCCGLCertificatePageViewState extends GeneralPageViewState{
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          title('Carta de Curso', context),
                          title('Grau de Licenciado', context),
                        ],
                      ),
                    ),
                  ],
