...
class NewCGLCertificatePageView extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => NewCGLCertificatePageViewState();
}

class NewCGLCertificatePageViewState extends GeneralPageViewState{
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          title('Certidão de Grau', context),
                          title('de Licenciado', context),
                        ],
                      ),
                    ),
                  ],
