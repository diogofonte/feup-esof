...
class NewCIACCertificatePageView extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => NewCIACCertificatePageViewState();
}

class NewCIACCertificatePageViewState extends GeneralPageViewState{
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          title('em Ano Curricular', context),
                        ],
                      ),
                    ),
                  ],
