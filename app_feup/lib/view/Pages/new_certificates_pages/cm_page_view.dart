...
class NewCMCertificatePageView extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => NewCMCertificatePageViewState();
}

class NewCMCertificatePageViewState extends GeneralPageViewState{
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          title('Certidão de Matrícula', context),
                          //title('Matrícula', context),
                        ],
                      ),
                    ),
                  ],
