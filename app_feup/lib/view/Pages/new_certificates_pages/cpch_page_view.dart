...
class NewCPCHCertificatePageView extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => NewCPCHCertificatePageViewState();
}

class NewCPCHCertificatePageViewState extends GeneralPageViewState{
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          title('Certidão de Programas', context),
                          title('e Cargas Horárias', context),
                        ],
                      ),
                    ),
                  ],
