...
class NewCRUCCertificatePageView extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => NewCRUCCertificatePageViewState();
}

class NewCRUCCertificatePageViewState extends GeneralPageViewState{
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          title('Certidão de Realização', context),
                          title('de Unidades Curriculares', context),
                        ],
                      ),
                    ),
                  ],
